...
def genEurope_Paper3(section):
    ...
    section = int(input("\nNew Two Questions With, Section: "))
...
def genWorldHistoryQuestion(topic):
    command_terms = [
        "Analyze",
        "Compare",
        "Compare and Contrast",
...
# Two Questions a Time
numberOfQuestions = 2

user_input = input("""

Press enter to continue. 
Or write 2 to switch to Paper 2 mode.
Or write 3 to switch to Paper 3 mode.
...
if user_input == "2":
    ...
    while True:
        try:
            numberOfQuestions = int(input("How many questions per topic? (1-10): "))
        except:
...
while True:
    clear()
    # choice = input("Paper 2, or Paper 3? (Please Write either 2 or 3 [x to close]): ")\
    if paper2Mode == True:
        try:
        ...
        if topic < 1 or topic > 18:
            ...
            continue
        clear()
        print(f"[bold]Topic: {europe_paper3_section_names[topic-1]}[/bold]\n\n")
